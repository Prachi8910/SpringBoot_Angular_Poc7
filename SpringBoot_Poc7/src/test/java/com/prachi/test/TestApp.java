...
public class TestApp {
	...
	public void addUserTest() throws Exception {
		...
		MvcResult result = mockMvc
				.perform(post("/springboot-crud-rest/users").content(payload).contentType(MediaType.APPLICATION_JSON_VALUE))
	...
	public void getAllUsersTest() throws Exception {
		...
		MvcResult result = mockMvc.perform(get("/springboot-crud-rest/users")
	...
	public void updateUserTest() throws Exception {
		...
		MvcResult result = mockMvc
				.perform(put("/springboot-crud-rest/users/1").content(payload).contentType(MediaType.APPLICATION_JSON_VALUE))
				.andExpect(status().isOk()).andReturn();
		int status = result.getResponse().getStatus();
	...
	public void deleteUserTest() throws Exception {
		...
		MvcResult result = mockMvc.perform(delete("/springboot-crud-rest/users/1").contentType(MediaType.APPLICATION_JSON_VALUE))
				.andExpect(status().isOk()).andReturn();
	...
	public void getUserbyIdTest() throws Exception {
		...
		MvcResult result = mockMvc.perform(get("/springboot-crud-rest/users/getUserById/1").contentType(MediaType.APPLICATION_JSON_VALUE))
				.andExpect(status().isOk()).andReturn();
	...
	public void searchByNameTest() throws Exception {
		...
		MvcResult result = mockMvc
				.perform(get("/springboot-crud-rest/users/getUserByFname/Shreya2").contentType(MediaType.APPLICATION_JSON_VALUE))
				.andExpect(status().isOk()).andReturn();
	...
	public void searchByZipCodeTest() throws Exception {
		...
		MvcResult result = mockMvc
				.perform(get("/springboot-crud-rest/users/getUserByZipcode/409456").contentType(MediaType.APPLICATION_JSON_VALUE))
				.andExpect(status().isOk()).andReturn();
		assertEquals(200, result.getResponse().getStatus());
	}
